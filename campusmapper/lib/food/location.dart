...
class LocationService {
  final List<RestaurantLocation> hardcodedRestaurantLocations = [
    ...
    RestaurantLocation(name: 'Hunter Kitchen', latitude: 43.9455932, longitude: -78.896558),
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => ListMapScreen(
          ...
          restaurantLocations: hardcodedRestaurantLocations, // Pass the list of restaurant locations to the map screen
        ),
      ),
    );
  }
