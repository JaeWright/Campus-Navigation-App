...
class HelpButton extends StatelessWidget {
    ...
    final VoidCallback onPressed; // defined callback function to be triggered when pressed

    HelpButton({required this.onPressed}); // constructor to initialize the onpressed callback
